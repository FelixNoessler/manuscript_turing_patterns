...
function run_sim_kS_kI(; nvals)
    ...
    tspan = (0.0, 100_000.0)   # (0.0, 100_000.0)
    tsave = 95_000.0:100_000.0 # 95_000.0:100_000.0
    ######################
    ...
    p = (
        ...
        # kS = 0.0,      # 0, 2
        # kI = 0.0,      # 0, 2
        # dmaxS = 2,     # 10^-3 to 10^1
        # dmaxI = 0.01,  # 10^-3 to 10^1
    )
    ######################
...
@info "Run simulations for figure S6"
sim_result = run_sim_kS_kI(; nvals)
jldsave("simulation_results/S6_kS_kI.jld2"; sim_result...)
